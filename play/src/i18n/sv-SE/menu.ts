...
const menu: BaseTranslation = {
    ...
    profile: {
        login: "Logga in",
        logout: "Logga ut",
        helpAndTips: "Hjälp och introduktion",
    },
    settings: {
        videoBandwidth: {
            title: "Video quality",
        ...
        privacySettings: {
            title: "När fliken är dold",
            explanation: "När Kaffekontoret inte syns växlar du till frånvaroläge.",
            cameraToggle: "Låt kameran vara på i frånvaroläge",
            microphoneToggle: "Låt mikrofonen vara på i frånvaroläge",
        },
        save: "Spara",
        otherSettings: "Alla inställningar",
        fullscreen: "Helskärm",
        notifications: "Notiser",
        enablePictureInPicture: "Aktivera bild-i-bild",
        chatSounds: "Chattljud",
        ...
        proximityDiscussionVolume: "Samtalsvolym",
        blockAudio: "Blockera omgivningsljud och musik",
        disableAnimations: "Stäng av animationer på kartan",

...
export const AUTHENTICATION_ALLOWED_EMAILS = env.AUTHENTICATION_ALLOWED_EMAILS;
export const AUTHENTICATION_ALLOWED_EMAIL_DOMAINS = env.AUTHENTICATION_ALLOWED_EMAIL_DOMAINS;
export const PILOT_SESSION_SECRET = env.PILOT_SESSION_SECRET;
export const PILOT_WORKSPACE_ID = env.PILOT_WORKSPACE_ID || "kaffekontoret";
...
export const FRONT_ENVIRONMENT_VARIABLES: FrontConfigurationInterface = {
    ...
    KAFFEKONTORET_ROOM_MUSIC_URL: env.KAFFEKONTORET_ROOM_MUSIC_URL,
